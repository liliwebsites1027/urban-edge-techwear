    ...
    <section className="bg-[#0a0a0c] py-24 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex justify-center mt-12">
          <Link
            href="/shop"
            className={`${orbitron.className} group relative px-12 py-3 border border-white text-white text-[14px] tracking-widest transition-all duration-300 hover:bg-white hover:text-black`}
          >
            Shop All
          </Link>
        </div>
